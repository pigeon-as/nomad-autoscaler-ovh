...
| `ovh_hostname` | `""` | Hostname for the server during OS reinstall. If unset, OVH assigns a default |
| `ovh_display_name` | `""` | Display name set via OVH `/services/{id}` after delivery. If unset, not changed |
